...
# 获取参考答案
refs = []
with open("./data68/references/EC/1.EC ref.txt", encoding="utf8") as f:
    refs.append(f.readlines())
with open("./data68/references/EC/2.EC ref.txt", encoding="utf8") as f:
    refs.append(f.readlines())
with open("./data68/references/EC/3.EC ref.txt", encoding="utf8") as f:
    refs.append(f.readlines())
p_refs = []
n=0
for ref in refs:
...
# 测试文件夹    
file_path = "./data68/E-to-C-Sentence/"
...
# 保存结果
import json
with open("68_ec_bleurt_3ref_score.json", "w", encoding="utf8") as f:
